...
META = {
 ...
 'agBh':    ('Backhaul tender', 'Scouts empty lanes and drafts tenders — analysis is automatic, nothing sends without you.', 'Auto: matching, pricing, and lane analysis. Needs you: every tender — nothing sends without your approval.'),
